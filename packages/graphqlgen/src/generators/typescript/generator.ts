...
import { upperFirst, uniq } from '../../utils'
...
function renderHeader(
  ...
  let enumImports = ''
  if (enums.length > 0) {
    enumImports = `import {${uniq(enums).join(', ')}} from './enums';`
  }
  return `
...
function getReferencedEnums(
  ...
  // The type names let use get all enums used by that
  // object/input type
...
// The models needed to import for a objects file
function getObjectNeededModels(
  ...
  // Models used in its fields
  type.fields
    // We don't need primitive types
